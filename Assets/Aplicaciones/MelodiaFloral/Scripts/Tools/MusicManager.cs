...
{	
    ...
    public float MusicVolume //este es el nombre de la variable guardada en AppConstant
    {
        get
        {
    ...
    public float  SfxVolume //este es el nombre de la variable guardada en AppConstant
    {
        get
        {
            return m_sfxVolume;
    ...
    public  override void Awake                ()
	{
        ...
        //leemos los niveles de volumen guardados de la anterior configuración
        ...
        //asignamos los audios de música general
    ...
    //creamos un AudioSource desde el MusigManager
